        ...
        <footer className="text-white  relative bg-[#1a1a1a] pt-16">
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center mb-16 md:mb-24">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 ">HAVE ANY PROJECTS IN MIND?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16 md:mb-16">
                    ...
                    <div>
                        ...
                        <div className="flex w-full max-w-sm items-center space-x-2">
                            ...
                            <button
                                type="submit"
                                className="inline-flex items-center justify-center text-sm font-medium text-white hover:text-[#7f45ee]"
