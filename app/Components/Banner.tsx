...
export function Banner() {
  return (
    <section className="relative z-30 flex min-h-[calc(100vh-9rem)] md:min-h-[calc(100vh-4rem)] items-center justify-center md:px-8 lg:py-24 pt-20 pb-5 md:pt-0" id="home">
