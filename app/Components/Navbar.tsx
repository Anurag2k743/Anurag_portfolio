...
export function Header() {
  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50 w-full px-4 md:px-6">
      <div
        className={
          `max-w-8xl mx-auto flex items-center justify-between rounded-full px-6 py-3 backdrop-blur-lg transition-all duration-300 ` +
          (isScrolled
            ? "border border-blue-500 shadow-[0_0_20px_rgba(0,191,255,0.4)]"
